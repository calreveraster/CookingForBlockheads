...
public class CommonProxy {
    ...
    public void init(FMLInitializationEvent event) {
        ...
        GameRegistry.registerBlock(
                CookingForBlockheads.blockCookingTable, ItemBlockGenericKitchen.class, "cookingtable", new Object[] {
                    "cookingtable", true
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockOven, ItemBlockGenericKitchen.class, "cookingoven", new Object[] {
                    "cookingoven", false
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockCounter, ItemBlockGenericKitchen.class, "counter", new Object[] {
                    "counter", true
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockCounterCorner, ItemBlockGenericKitchen.class, "countercorner", new Object[] {
                    "countercorner", true
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockCabinet, ItemBlockGenericKitchen.class, "cabinet", new Object[] {
                    "cabinet", true
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockCabinetCorner, ItemBlockGenericKitchen.class, "cabinetcorner", new Object[] {
                    "cabinetcorner", true
                });
        ...
        GameRegistry.registerBlock(
                CookingForBlockheads.blockSink, ItemBlockGenericKitchen.class, "sink", new Object[] {"sink", true});
        GameRegistry.registerBlock(
                CookingForBlockheads.blockToolRack, ItemBlockGenericKitchen.class, "toolrack", new Object[] {
                    "toolrack", false
                });
        GameRegistry.registerBlock(
                CookingForBlockheads.blockToaster, ItemBlockGenericKitchen.class, "toaster", new Object[] {
                    "toaster", false
                });
        ...
        if (CookingConfig.enableNoFilter) {
            GameRegistry.addShapelessRecipe(
                    new ItemStack(CookingForBlockheads.itemRecipeBook, 1, 3), Items.book, Items.painting);
        }
        ...
        if (CookingConfig.gregtech5uLoaded) {
            ...
            GameRegistry.addShapelessRecipe(
                    new ItemStack(CookingForBlockheads.blockFridge), Blocks.chest, Items.iron_door);
        }
        ...
        if (CookingConfig.gregtech5uLoaded) {
            ...
            GameRegistry.addRecipe(new ShapedOreRecipe(
                    new ItemStack(CookingForBlockheads.blockCabinetCorner), "CCC", "CCC", 'C', Blocks.hardened_clay));
        }
    ...
    public void postInit(FMLPostInitializationEvent event) {
        ...
        if (CookingConfig.moduleStorageDrawers) {
            event.buildSoftDependProxy(
                    "StorageDrawers", "net.blay09.mods.cookingforblockheads.compat.StorageDrawersAddon");
        }
