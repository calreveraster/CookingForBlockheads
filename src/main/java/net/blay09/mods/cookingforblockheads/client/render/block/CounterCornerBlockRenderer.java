...
public class CounterCornerBlockRenderer implements ISimpleBlockRenderingHandler {

    public static final int RENDER_ID = RenderingRegistry.getNextAvailableRenderId();
    private static final TileCounterCorner tileEntity = new TileCounterCorner();
