...
public class ComparatorSaturation implements Comparator<ItemStack> {
    ...
    public int compare(ItemStack o1, ItemStack o2) {
        ...
        int result = (int) (CookingForBlockheadsAPI.getFoodStatsProvider().getSaturation(o2, entityPlayer) * 100
                - CookingForBlockheadsAPI.getFoodStatsProvider().getSaturation(o1, entityPlayer) * 100);
        if (result == 0) {
