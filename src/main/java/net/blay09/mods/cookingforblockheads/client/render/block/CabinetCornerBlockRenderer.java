...
public class CabinetCornerBlockRenderer implements ISimpleBlockRenderingHandler {

    public static final int RENDER_ID = RenderingRegistry.getNextAvailableRenderId();
    private static final TileCabinetCorner tileEntity = new TileCabinetCorner();
