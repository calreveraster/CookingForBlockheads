/*
 * DyeUtils - borrowed from Minecraft Forge 1.12 Copyright (c) 2016-2020. This library is free software; you can
 * redistribute it and/or modify it under the terms of the GNU Lesser General Public License as published by the Free
 * Software Foundation version 2.1 of the License. This library is distributed in the hope that it will be useful, but
...
public class DyeUtils {
    ...
    public static final String[] dyeOredicts = new String[] { "dyeWhite", "dyeOrange", "dyeMagenta", "dyeLightBlue",
    ...
    public static final String[] dyeNamesSnakeCase = new String[] { "white", "orange", "magenta", "light_blue",
     ...
     * sentinel); this follows vanilla conventions.
     * 
     * @param stack the item stack
